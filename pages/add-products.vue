...
<template>
  <div class="mx-auto max-w-[450px]">
    <p class="font-bold text-base pb-4">Adicionar produtos:</p>

    <div @submit="onSubmit">
      <label class="text-sm pb-2" for="nome"> Nome do produto: </label>
      ...
      <label class="text-sm pb-2" for="quantidade"> Quantidade: </label>
      ...
      <label class="text-sm pb-2" for="link"> Setor: </label>
      ...
      <button v-if="cameraOn" class="btn-primary" @click="openCamera">
        <img :src="camera" alt="câmera" />
        Câmera
      </button>

      <video v-if="openPlayer" class="my-2 rounded-lg" ref="player" />

      <button v-if="!cameraOn" class="btn-primary" @click="takePhoto">
        <img :src="camera" alt="câmera" />
        Tirar foto
      </button>
      ...
      <div class="flex gap-2">
        ...
        <button class="btn-positive" @click="onSubmit">Salvar</button>
      </div>
    </div>
  </div>
</template>
